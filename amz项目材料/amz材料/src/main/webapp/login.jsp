...
<div id="register" class="wrap">
	<div class="shadow">
		...
		<div class="box">
			<h1>欢迎回到亚马逊</h1>
			<form id="loginForm" method="post" action="${pageContext.request.contextPath}/loginclient" onsubmit="return loginCheck()">
				<table>
					<tr>
					...
					<tr>           
						...
						<td><input class="text verycode" type="text" name="veryCode" onfocus="FocusItem(this)" onblur="CheckItem(this);" maxlength="4"/>
