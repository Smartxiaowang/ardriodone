...
<div id="register" class="wrap">
	<div class="shadow">
		...
		<div class="box">
			...
			<form id="regForm" method="post" action="${pageContext.request.contextPath }/register" onsubmit="return checkForm(this)" enctype="multipart/form-data">
				<table>
					<tr>
					...
					<tr>
						...
						<td><input id="cardId" class="text" type="text" name="identity" onfocus="FocusItem(this)" onblur="CheckItem(this);" /><span id="cardid"></span></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input class="text" type="file" name="IDcard" id="upload" /><span></span></td>
					</tr>
					<tr>
