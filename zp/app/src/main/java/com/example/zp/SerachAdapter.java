...
public class SerachAdapter extends RecyclerView.Adapter<SerachAdapter.ViewHolder> {
    ...
    public SerachAdapter(List<ZpInfoEntity> dataList, Context context, String userName) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.serachreslist, parent, false);
