...
<%@ page import = "bean.AdminBean,bean.HistoryBean,dao.JiudianDao,dao.AdminDao" %>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="collapse navbar-collapse main-navbar-collapse">
                    <a class="navbar-brand" href="/reader.js"><strong>欢迎使用酒店住房管理系统</strong></a>
...
<div class="container">
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default bootstrap-admin-no-table-panel">
                            <div class="panel-heading">
                                <div class="text-muted bootstrap-admin-box-title">当前预订信息</div>
                            </div>
  ...
  %>                 
                            	<tbody>
	                                ...
	                                <td>
<button type="button" class="btn btn-info btn-xs" data-toggle="modal" onclick="haijiudian(<%= bean.getHid() %>)">退房</button>
	                                </td>                                               
                          	  </tbody>
                             <%} %> 
                        </table>
    ...
    function haijiudian(hid) {
    	con=confirm("是否退房?");
    	if(con==true){
    		location.href = "/jiudain/borrowServlet?tip=2&hid="+hid;
    	}
    }
    </script>
        </div>
									...
									<div class="modal fade" id="findBackModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
										...
										<!---------------------表单-------------------->
										 <div class="form-group">
											<label for="firstname" class="col-sm-3 control-label">预订编号</label>
												<div class="col-sm-7">
										...
										<div class="form-group">	
											<label for="firstname" class="col-sm-3 control-label">预订书籍ISBN号</label>
											<div class="col-sm-7">
										...
										<div class="form-group">	
											<label for="firstname" class="col-sm-3 control-label">预订书籍名称</label>
												<div class="col-sm-7">
													<input type="text" class="form-control" id="jiudianName"  readonly="readonly">
												
												</div>
										</div>
										<div class="form-group">	
											<label for="firstname" class="col-sm-3 control-label">预订书籍类型</label>
												<div class="col-sm-7">
													<input type="text" class="form-control" id="jiudianType"  readonly="readonly">
										...
										<div class="form-group">	
											<label for="firstname" class="col-sm-3 control-label">退房状态</label>
												<div class="col-sm-7">
