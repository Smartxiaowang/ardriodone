...
<div class="container">
    <div class="row">
        <div class="col-lg-12">
            ...
            <form class="bootstrap-admin-login-form" method="post" action="/jiudain/LoginServlet">
                ...
                <%};%>
                <br /> <!--加这个表示换行-->
                <label class="control-label" for="password">没有账号请<a href="/jiudain/register.jsp" style="color:blue;">注册</a></label>
                <br>
                <!-- <label class="control-label" for=""><a href="/jiudain/admin.jsp" style="color:blue;">管理员登录</a></label> -->
                <br>
