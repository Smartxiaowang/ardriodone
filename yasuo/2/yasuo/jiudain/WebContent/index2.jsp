                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <div class="text-muted bootstrap-admin-box-title">客房查询</div>
                        </div>
                        <div class="bootstrap-admin-panel-content">
                            <ul>
                                <li>根据客房编号、客房名称查询客房信息</li>
                                <li>可查询客房的编号、名称、分类 等</li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <!-- 判断用户是否登录 -->
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <div class="text-muted bootstrap-admin-box-title">预订信息</div>
                        </div>
                        <div class="bootstrap-admin-panel-content">
                            <ul>
                                <li>可查询除客房的基本信息、预订日期、截止退房日期</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <div class="text-muted bootstrap-admin-box-title">预订历史</div>
                        </div>
                        <div class="bootstrap-admin-panel-content">
                            <ul>
                                <li>查询自己以往的预订历史，包括哪些客房等具体信息</li>
                            </ul>
                        </div>
                    </div>
                </div>
