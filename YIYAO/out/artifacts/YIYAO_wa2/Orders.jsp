 ...
 <input type="hidden" id="hidUId" name="hidUId" value="${modfiyOrder.uId }"/>  
            ...
            <div class="row">
             ...
             <c:if test="${not empty modfiyOrder}">药品信息修改</c:if>
              ...
              <c:if test="${empty modfiyOrder}"><a href="#" class="wminimize"><i class="icon-chevron-down"></i></a></c:if> 
              <c:if test="${not empty modfiyOrder}"><a href="#" class="wminimize"><i class="icon-chevron-up"></i></a></c:if>
             <a href="#" class="wclose"><i class="icon-remove"></i></a>
                  </div>
                  <div class="clearfix"></div>
                </div>

                <div class="widget-content" <c:if test="${empty modfiyOrder}"> style="display:none;"</c:if>>
                  <div class="padd">
                    ...
                    <!-- Form starts.  -->
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-md-8">
        <input type="text" class="form-control" placeholder="数量" value="${modfiyOrder.number }"  name="txtNumber" id="txtNumber">
        <span class="label label-danger" id="spanNumber"></span>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-md-8">
        <input type="text" class="form-control" placeholder="药名" value="${modfiyOrder.name }" name="txtName" id="txtName">
        <span class="label label-danger" id="spanName"></span>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-md-8">
        <input type="text" class="form-control" placeholder="类别" value="${modfiyOrder.type }"  name="txtType" id="txtType"
        	value="0">
        <span class="label label-danger" id="spanStudentCount"></span>                      
                                  ...
                                  <div class="col-md-8">
        <input type="text" class="form-control" placeholder="描述" value="${modfiyOrder.description }"  name="txtDescription" id="txtDescription"
        	value="0">
        <span class="label label-danger" id="spanStudentCount"></span>                      
                                  </div>
                                </div>    
                  ...
                  <div class="widget-content">
					...
					<c:forEach items="${requestScope.orders }" var="order"  > 
                        <tr>
                          ...
                          <td>                             
                              <button class="btn btn-xs btn-warning"  onclick="modfiy(${order.uId})" ><i class="icon-pencil"></i> </button>
                              <button class="btn btn-xs btn-danger"  onclick="remove(${order.uId})"><i class="icon-remove"></i> </button>
